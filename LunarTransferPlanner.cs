...
#region NO_LOCALIZATION
        ...
        private void ExpandCollapse(ref bool button, string tooltip = "", bool overrideButton = false)
        {
            ...
            if (GUILayout.Button(new GUIContent(!button ? "+" : "–", tooltip + (overrideButton ? Localizer.Format("#LOC_LTP_54") : "")), GUILayout.Width(30))) // en dash shows up as the same width as + ingame, while the minus symbol is way thinner
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (addAlarm)
                    {
                        ...
                        DescribeD(Localizer.Format("#LOC_LTP_100"), "°", latitude);
                        DescribeD(Localizer.Format("#LOC_LTP_101"), "°", longitude);
                        ...
                        DescribeD(Localizer.Format("#LOC_LTP_107"), "°", (isLowLatitude && !useAltBehavior) ? launchOrbit1.azimuth > 90d && launchOrbit1.azimuth < 270d ? -launchOrbit1.inclination : launchOrbit1.inclination : targetLaunchInclination);
                        DescribeD(Localizer.Format("#LOC_LTP_108"), "°", (isLowLatitude && !useAltBehavior) ? launchOrbit1.azimuth : targetLaunchAzimuth);
                        DescribeD(Localizer.Format("#LOC_LTP_109"), Localizer.Format("#LOC_LTP_74"), phaseTime1);
                        DescribeD(Localizer.Format("#LOC_LTP_110"), "°", phaseAngle1);
                        DescribeD(Localizer.Format("#LOC_LTP_111"), "°", launchLAN1);
                        DescribeD(Localizer.Format("#LOC_LTP_112"), "°", launchAoP1);
